...
(function() {
    ...
    function b(t, e) {
        e._state === it ? S(t, e._result) : e._state === st ? j(t, e._result) : E(e, void 0,
        function(e) {
            g(t, e)
        },
        function(e) {
    ...
    function q(t) {
        ...
        function(n, r) {
            for (var o = t.length,
            i = 0; o > i; i++) e.resolve(t[i]).then(n, r)
        }: function(t, e) {
    ...
    function N(t, e) {
        ...
        I(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? S(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && S(this.promise, this._result))) : j(this.promise, U())
    }
    function U() {
    ...
    N.prototype._enumerate = function() {
        ...
        e = this._input,
        n = 0; this._state === ot && t > n; n++) this._eachEntry(e[n], n)
    },
...
function(t) {
    var e = function() {
        ...
        function U(t) {
            return "children" in t ? u.call(t.children) : r.map(t.childNodes,
            function(t) {
        ...
        function tt(t, e) {
            e(t);
            for (var n = 0,
            r = t.childNodes.length; r > n; n++) tt(t.childNodes[n], e)
        }
        var e, n, r, i, O, P, o = [],
        s = o.concat,
        a = o.filter,
        ...
        N.fragment = function(t, n, i) {
            ...
            o || (t.replace && (t = t.replace(m, "<$1></$2>")), n === e && (n = p.test(t) && RegExp.$1), n in j || (n = "*"), a = j[n], a.innerHTML = "" + t, o = r.each(u.call(a.childNodes),
            function() {
                a.removeChild(this)
            })),
            Z(i) && (s = r(o), r.each(i,
        ...
        N.init = function(t, n) {
            var i;
            if (!t) return N.Z();
            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && p.test(t)) i = N.fragment(t, RegExp.$1, n),
            t = null;
            else {
                ...
                t = null;
                else if (p.test(t)) i = N.fragment(t.trim(), RegExp.$1, n),
                t = null;
                else {
                    if (n !== e) return r(n).find(t);
                    i = N.qsa(f, t)
        ...
        r.map = function(t, e) {
            var n, i, o, r = [];
            if (z(t)) for (i = 0; i < t.length; i++) n = e(t[i], i),
            null != n && r.push(n);
        ...
        r.fn = {
            ...
            ready: function(t) {
                return w.test(f.readyState) && f.body ? t(r) : f.addEventListener("DOMContentLoaded",
                function() {
                    t(r)
                },
                !1),
            ...
            filter: function(t) {
                return F(t) ? this.not(this.not(t)) : r(a.call(this,
                function(e) {
            ...
            parents: function(t) {
                for (var e = [], n = this; n.length > 0;) n = r.map(n,
                function(t) {
            ...
            attr: function(t, r) {
                ...
                return "string" != typeof t || 1 in arguments ? this.each(function(e) {
                    if (1 === this.nodeType) if (R(t)) for (n in t) G(this, n, t[n]);
    ...
    function(e) {
        ...
        function T(t, n) {
            return (n || !t.isDefaultPrevented) && (n || (n = t), e.each(w,
            function(e, r) {
                var i = n[e];
                t[e] = function() {
                    return this[r] = b,
                ...
                t[r] = E
            }), t.timeStamp || (t.timeStamp = Date.now()), (n.defaultPrevented !== r ? n.defaultPrevented: "returnValue" in n ? n.returnValue === !1 : n.getPreventDefault && n.getPreventDefault()) && (t.isDefaultPrevented = b)),
            t
        }
        function S(t) {
            var e, n = {
    ...
    function(e) {
        ...
        function S(t) {
            ...
            !t.data || t.type && "GET" != t.type.toUpperCase() && "jsonp" != t.dataType || (t.url = T(t.url, t.data), t.data = void 0)
        }
        function C(t, n, r, i) {
        ...
        e.ajax = function(n) {
            ...
            var c = s.dataType,
            p = /\?.+=\?/.test(s.url);
            if (p && (c = "jsonp"), s.cache !== !1 && (n && n.cache === !0 || "script" != c && "jsonp" != c) || (s.url = T(s.url, "_=" + Date.now())), "jsonp" == c) return p || (s.url = T(s.url, s.jsonp ? s.jsonp + "=?": s.jsonp === !1 ? "": "callback=?")),
            e.ajaxJSONP(s, a);
            var P, d = s.accepts[c],
            g = {},
            b = function(t, e) {
    ...
    return function e(t, n, r) {
        ...
        3 : [function(t, e) {
            ...
            n.prototype.emit = function(t) {
                ...
                if (e) for (var n = Array.prototype.slice.call(arguments, 1), r = 0; r < e.length; r++) e[r].apply(this, n)
            },
        ...
        14 : [function(t, e) { (function(n) {
                ...
                r.prototype._connect = function() {
                    for (var t = this._transports.shift(); t; t = this._transports.shift()) {
                        if (t.needBody && (!n.document.body || "undefined" != typeof n.document.readyState && "complete" !== n.document.readyState && "interactive" !== n.document.readyState)) return this._transports.unshift(t),
                ...
                r.prototype._transportClose = function(t, e) {
                    return this._transport && (this._transport.removeAllListeners(), this._transport = null, this.transport = null),
        ...
        15 : [function() {
            ...
            p(s, {
                bind: function(t) {
                    ...
                    return e.prototype && (n.prototype = e.prototype, l.prototype = new n, n.prototype = null),
                    l
                }
            }),
            p(Array, {
            ...
            function() {
                ...
                a.split = function(n, r) {
                    ...
                    d = 0;
                    for (n = new RegExp(n.source, h + "g"), o += "", t || (s = new RegExp("^" + n.source + "$(?!\\s)", h)), r = void 0 === r ? -1 >>> 0 : e(r); (a = n.exec(o)) && (u = a.index + a[0].length, !(u > d && (f.push(o.slice(d, a.index)), !t && a.length > 1 && a[0].replace(s,
                    function() {
            ...
            var x = "	\n\f\r  釟€釥庘€€鈥佲€傗€冣€勨€呪€嗏€団€堚€夆€娾€仧銆€\u2028\u2029锘�",
            _ = "鈥�",
            E = "[" + x + "]",
            j = new RegExp("^" + E + E + "*"),
            T = new RegExp(E + E + "*$"),
        ...
        17 : [function(t, e) { (function(n) {
                ...
                r.enabled = !!u;
                var l = ["Active"].concat("Object").join("X"); ! r.enabled && l in n && (u = function() {
                    try {
        ...
        18 : [function(t, e) { (function(t) {
                e.exports = t.EventSource
            }).call(this, "undefined" != typeof global ? global: "undefined" != typeof self ? self: "undefined" != typeof window ? window: {})
        },
        {}],
        19 : [function(t, e) { (function(t) {
        ...
        22 : [function(t, e) {
            ...
            function n(t, e, r) {
                ...
                this.iframeObj = u.createIframe(s,
                function(t) {
        ...
        25 : [function(t, e) {
            ...
            n.prototype.sendSchedule = function() {
                ...
                if (this.sendBuffer.length > 0) {
                    ...
                    function(e) {
                        t.sendStop = null,
                        e ? (t.emit("close", e.code || 1006, "Sending error: " + e), t._cleanup()) : t.sendScheduleWait()
                    }),
                    this.sendBuffer = []
                }
            },
        ...
        31 : [function(t, e) { (function(n) {
                ...
                r.prototype._createScript = function(t) {
                    ...
                    "undefined" == typeof i.async && n.document.attachEvent) if (s.isOpera()) e = this.script2 = n.document.createElement("script"),
        ...
        43 : [function(t, e) { (function(t) {
                "use strict";
                e.exports.randomBytes = t.crypto && t.crypto.getRandomValues ?
                function(e) {
        ...
        50 : [function(t, e) {
            ...
            e.exports = {
                string: function(t) {
                    for (var e = r.length,
                    i = n.randomBytes(t), o = [], s = 0; t > s; s++) o.push(r.substr(i[s] % e, 1));
                    return o.join("")
                },
                number: function(t) {
        ...
        55 : [function(e, n, r) { (function(e) { (function() {
                        ...
                        if (!n("json")) {
                            ...
                            !n("json-stringify")) {
                                ...
                                U = function(t, e, n, r, i, o, s) {
                                    ...
                                    if ("object" == typeof a && a) if (u = b.call(a), u != _ || p.call(a, "toJSON"))"function" == typeof a.toJSON && (u != E && u != j && u != T || p.call(a, "toJSON")) && (a = a.toJSON(t));
                                    else if (a > -1 / 0 && 1 / 0 > a) {
                                        if (N) {
                                    ...
                                    if ("object" == typeof a) {
                                        ...
                                        if (s.push(a), O = [], L = o, o += i, u == T) {
                                            for (k = 0, I = a.length; I > k; k++) A = U(k, a, n, r, i, o, s),
                                            O.push(A === m ? "null": A);
                                            M = O.length ? i ? "[\n" + o + O.join(",\n" + o) + "\n" + L + "]": "[" + O.join(",") + "]": "[]"
                                        } else v(r || a,
                                        function(t) {
                                ...
                                e.stringify = function(t, e, n) {
                                    var r, i, o, a;
                                    if (s[typeof e] && e) if ((a = b.call(e)) == x) i = e;
                                    else if (a == T) {
                                        o = {};
                                        for (var u, l = 0,
                                        c = e.length; c > l; u = e[l++], a = b.call(u), (a == j || a == E) && (o[u] = 1));
                                    }
                            ...
                            if (!n("json-parse")) {
                                ...
                                B = function() {
                                    for (var t, e, n, r, i, o = q,
                                    s = o.length; s > M;) switch (i = o.charCodeAt(M)) {
                                    case 9:
                                    case 10:
                                    case 13:
                                    case 32:
                                    ...
                                    case 44:
                                        ...
                                        t;
                                    case 34:
                                        for (t = "@", M++; s > M;) if (i = o.charCodeAt(M), 32 > i) J();
                                        ...
                                        case 114:
                                            ...
                                            break;
                                        case 117:
                                            for (e = ++M, n = M + 4; n > M; M++) i = o.charCodeAt(M),
                                    ...
                                    default:
                                        ...
                                        if (r && J(), "true" == o.slice(M, M + 4)) return M += 4,
                                        !0;
                                        if ("false" == o.slice(M, M + 5)) return M += 5,
                                        !1;
                                        if ("null" == o.slice(M, M + 4)) return M += 4,
                                        null;
                                        J()
                                    }
                                    return "$"
                                ...
                                G = function(t) {
                                    ...
                                    if ("$" == t && J(), "string" == typeof t) {
                                        ...
                                        if ("[" == t) {
                                            for (e = []; t = B(), "]" != t; n || (n = !0)) n && ("," == t ? (t = B(), "]" == t && J()) : J()),
                                            "," == t && J(),
                                            e.push(G(t));
                                            return e
                                        }
                                ...
                                H = function(t, e, n) {
                                    var r, i = t[e];
                                    if ("object" == typeof i && i) if (b.call(i) == T) for (r = i.length; r--;) F(i, r, n);
                                    else v(i,
                                    function(t) {
                                        F(i, t, n)
                                    });
                    ...
                    if (!l || l.global !== l && l.window !== l && l.self !== l || (u = l), a && !o) i(u, a);
                        ...
                        d = i(u, u.JSON3 = {
                            noConflict: function() {
                                return h || (h = !0, u.JSON = c, u.JSON3 = f, c = f = null),
                                d
                            }
                        });
                        u.JSON = {
        ...
        56 : [function(t, e) {
            ...
            function n(t, e, u) {
                ...
                v = this,
                m = 0;
                for ("object" !== p && "string" !== p && (u = e, e = null), u && "function" != typeof u && (u = o.parse), e = i(e); m < a.length; m++) c = a[m],
                l = c[0],
                h = c[1],
                l !== l ? v[h] = t: "string" == typeof l ? ~ (f = t.indexOf(l)) && ("number" == typeof c[2] ? (v[h] = t.slice(0, f), t = t.slice(f + c[2])) : (v[h] = t.slice(f), t = t.slice(0, f))) : (f = l.exec(t)) && (v[h] = f[1], t = t.slice(0, t.length - f[0].length)),
                v[h] = v[h] || (c[3] || "port" === h && d ? e[h] || "": ""),
                c[4] && (v[h] = v[h].toLowerCase());
                u && (v.query = u(v.query)),
                r(v.port, v.protocol) || (v.host = v.hostname, v.port = ""),
                v.username = v.password = "",
                v.auth && (c = v.auth.split(":"), v.username = c[0] || "", v.password = c[1] || ""),
                v.href = v.toString()
            }
            ...
            n.prototype.set = function(t, e, n) {
                var i = this;
                return "query" === t ? ("string" == typeof e && (e = (n || o.parse)(e)), i[t] = e) : "port" === t ? (i[t] = e, r(e, i.protocol) ? e && (i.host = i.hostname + ":" + e) : (i.host = i.hostname, i[t] = "")) : "hostname" === t ? (i[t] = e, i.port && (e += ":" + i.port), i.host = e) : "host" === t ? (i[t] = e, /\:\d+/.test(e) && (e = e.split(":"), i.hostname = e[0], i.port = e[1])) : i[t] = e,
                i.href = i.toString(),
                i
            },
            n.prototype.toString = function(t) {
                ...
                var e, n = this,
                r = n.protocol + "//";
                return n.username && (r += n.username, n.password && (r += ":" + n.password), r += "@"),
                r += n.hostname,
                n.port && (r += ":" + n.port),
                r += n.pathname,
                n.query && (e = "object" == typeof n.query ? t(n.query) : n.query, r += ("?" === e.charAt(0) ? "": "?") + e),
                n.hash && (r += n.hash),
                r
            },
            n.qs = o,
...
function(t, s, e) {
    ...
    i.prototype = {
        ...
        typewrite: function(t, s) {
            if (this.stop !== !0) {
                ...
                i.timeout = setTimeout(function() {
                    ...
                    if ("^" === r.charAt(0)) {
                        var o = 1;
                        /^\^\d+/.test(r) && (r = /\d+/.exec(r)[0], o += r.length, e = parseInt(r)),
        ...
        backspace: function(t, s) {
            ...
            if (this.stop !== !0) {
                ...
                e.timeout = setTimeout(function() {
                    ...
                    var r = t.substr(0, s);
                    e.replaceText(r),
                    s > e.stopNum ? (s--, e.backspace(t, s)) : s <= e.stopNum && (e.arrayPos++, e.arrayPos === e.strings.length ? (e.arrayPos = 0, e.shuffle && (e.sequence = e.shuffleArray(e.sequence)), e.init()) : e.typewrite(e.strings[e.sequence[e.arrayPos]], s))
                },
                i)
            }
        },
        ...
        shuffleArray: function(t) {
            var s, e, i = t.length;
            if (i) for (; --i;) e = Math.floor(Math.random() * (i + 1)),
            s = t[e],
            t[e] = t[i],
            t[i] = s;
            return t
...
fg_api.prototype.adsModule = function() {
    ...
    module.prototype.init = function() {
        ...
        case 'dfp':
            ...
            faZepto.getScript("https://imasdk.googleapis.com/js/sdkloader/ima3.js", sdkLoadedCallback,
            function() {
                sdkLoadedCallback();
        ...
        function sdkLoadedCallback() {
            ...
            var geoReadyCallback = function() {
                ...
                if (self.config.ads.show_video_countries && self.config.ads.show_video_countries.indexOf(countryCode) > -1 || self.config.ads.show_video_countries.indexOf('**') > -1) {
    ...
    module.prototype.showAppTeaser2 = function(callback, force) {
        ...
        self.firebase.isReady().then(function() {
            ...
            self.firebase.database().ref(fgs_path).orderByChild("notify").equalTo(true).once("value",
            function(snapshot) {
    ...
    module.prototype.showAppTeaser = function(callback, force) {
        ...
        var packageId = '';
        var apps = ['smarty-bubbles', 'gold-mine', 'fruita-crush', 'fruita-swipe-2', 'candy-bubble', 'backgammon-classic', 'bubble-gems', 'bubble-spirit', 'solitaire-classic', 'streetrace-fury', 'smarty-bubbles-xmas', 'winter-lily', 'slacking-school', 'sudoku-classic', 'chess-classic', 'lovetester'];
    ...
    module.prototype.showIMA = function(callback, force) {
        ...
        try {
            ...
            if (typeof google === "undefined" && detection.is.pc) {
                var btn = faZepto("<div><h1 style='font-weight:normal;color:#647999; text-align: center; padding: 30px 0 10px 0 !important;'>Please disable your AdBlocker on this site to play our games!<img src='//games.cdn.famobi.com/html5games/gameapi/CandyInTears.png' alt='' style='margin: 0 auto; display: block; width: 270px; margin-top: 20px;'></h1><span style='display:inline-block;padding:15px;border:5px solid #647999;font-weight:bold; color: #647999;'>Done? Refresh this page.</span><br><br><span style='color:#647999; display: block; margin-bottom: 30px; opacity: 0.8;'><strong>Why?</strong> Some functionality is incorrectly blocked by AdBlockers</span><iframe src='//giphy.com/embed/RL6gd7A8xvLYA' width='320' height='246' frameBorder='0' allowFullScreen></iframe></div>").appendTo("body").css({
                    ...
                    "text-align": "center",
                    "z-index": self.rand(900000, 999999)
                });
                self.handleClick(btn.get(0),
                function() {
        ...
        module.prototype.onAdsManagerLoaded = function(adsManagerLoadedEvent) {
            ...
            faZepto.each(['LOADED', 'IMPRESSION', 'STARTED', 'SKIPPABLE_STATE_CHANGED', 'FIRST_QUARTILE', 'MIDPOINT', 'THIRD_QUARTILE', 'USER_CLOSE', 'SKIPPED', 'COMPLETE', 'ALL_ADS_COMPLETED', 'DURATION_CHANGE', 'CONTENT_RESUME_REQUESTED', 'CONTENT_PAUSE_REQUESTED'],
            function(key, value) {
    ...
    module.prototype.getAdTagUrl = function(variant) {
        ...
        M.dfp_custom_params = {
            ...
            "video": (M.show_video || M.show_video_initial) ? "1": "0",
            // allow video for desktop always; on mobile only for request A) because of the neccessary user interaction
        ...
        myadTagUrl = "https://securepubads.g.doubleclick.net/gampad/ads?impl=s&gdfp_req=1&env=vp&output=xml_vast4&overlay=0&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";
    ...
    module.prototype.getAdTagUrl2 = function() {
        ...
        // @see https://support.google.com/dfp_premium/answer/1068325?hl=de
        myadTagUrl = "https://googleads.g.doubleclick.net/pagead/ads?ad_type=image_video&client=ca-games-pub-8700401253704627&channel=8931917795&videoad_start_delay=0&max_ad_duration=15000";
    ...
    module.prototype.showMatchedContent = function(callback, force) {
        ...
        // show house ad
        var url = '/sda/matched_content/' + window.famobi_gameID + '/' + window.famobi.config.aid;
        self.iframe.show(url, opts);
        self.modal.setHeader(self.translate("api.ad_modal_header2"));
        self.modal.setCloseCallback(opts.returnCallback);
        self.modal.setCloseCallback(opts.returnCallback2);
    ...
    module.prototype.showBlocker = function(callback, force) {
        ...
        // show house ad
        var url = '/sda/blocker/' + window.famobi_gameID + '/' + window.famobi.config.aid;
        self.iframe.show(url, opts);
    ...
    module.prototype.showAppOverlay = function() {
        ...
        if (!M.isStock) {
            ...
            if (!M.appTeaser) {
                ...
                faZepto(M.appTeaser).find(".fg-app-teaser-storeIcon").addClass('fg-app-teaser-storeIcon-' + (detection.is.ios ? 'appStore': 'playStore'));
...
faZepto.fn.preventClick = function() {
    this.each(function() {
        faZepto(this).on("click touchstart touchmove touchcancel touchend",
        function(e) {
            e.stopPropagation();
            return false;
        });
...
fg_api.prototype.sdkModule = function() {
    ...
    module.prototype.init = function() {
        ...
        module.prototype.subscribePostMessageListener("sdk", "setItems",
        function(data) {
        ...
        module.prototype.subscribePostMessageListener("sdk", "game.setWaiting",
        function(data) {
...
fg_api.prototype.screenshotModule = function() {
    ...
    function displayScreenshotOverlay(imageSrc) {
        ...
        self.handleClick(M.fgSaveScreenshot,
        function() {
...
fg_api.prototype.modalModule = function() {
    ...
    modalPrototype.init = function() {
        self.iframe.subscribePostMessageListener("modal", "showModalCloseBtn",
        function() {
            M.showCloseBtn();
        }).subscribePostMessageListener("modal", "setModalHeader",
        function(data) {
            M.setHeader(data.title);
        }).subscribePostMessageListener("modal", "close",
        function(data) {
            M.close();
        }).subscribePostMessageListener("modal", "setModalCloseBtnTimer",
        function(data) {
            self.spinner.hide();
    ...
    modalPrototype.showCloseBtn = function() {
        ...
        self.handleClick(M.overlay,
        function() {
            if (!M.closeBtn.getAttribute("data-disable") && !M.overlay.getAttribute("data-disable")) M.close();
        });
    };
...
fg_api.prototype.iframeModule = function() {
    ...
    iframePrototype.show = function(url, options) {
        ...
        if (opts.mode && opts.mode == "ad") self.iframeElement.setAttribute("scrolling", "no");
...
fg_api.prototype.trackingModule = function() {
    ...
    trackingPrototype.init = function() {
        ...
        faZepto(self.rootElement).one('faGame:loaded',
        function() {
            if (window.famobi_env === "vp") {
    ...
    trackingPrototype.trackEvent = function(category, action, label, value, nonInteraction) {
        ...
        if (typeof M.floodProtectionMap[key] !== "undefined" && category != M.floodProtectionPrefix) {
    ...
    trackingPrototype.trackGamePlay = function() {
        return Promise.all([self.firebase.isReady(), self.geo.getCountryCode(), self.player.getPlayer()]).then(function(args) {
    ...
    module.prototype.getDeviceCategory = function() {
        if (null === M.dc) {
            ...
            case detection.is.pc:
                M.dc = "desktop";
                break;
            case detection.is.smartphone && detection.is.android: M.dc = "mobile";
                break;
            case detection.is.smartphone && detection.is.ios: M.dc = "mobile_ios";
                break;
            case detection.is.tablet && detection.is.android: M.dc = "tablet";
                break;
            case detection.is.tablet && detection.is.ios: M.dc = "tablet_ios";
                break;
            default:
                M.dc = "other";
            }
        ...
        return new Promise(function(resolve, reject) {
            ...
            self.firebase.isReady().then(function() {
                M.getRules().then(function() {
                    ...
                    var bestRulesRef = M.getDynamicRulesRef().orderByChild('amount_req_ecpm_weighted').limitToLast(nbRules);
...
fg_api.prototype.gametranslationModule = function() {
    ...
    gameTranslationPrototype.getGameTranslations = function() {
        ...
        i18n["default"], i18n[self.config.aid + ".default"], i18n[lang], i18n[self.config.aid + '.' + lang]);
...
fg_api.prototype.gameModule = function() {
    ...
    gamePrototype.prepare = function() {
        ...
        return new Promise(function(resolve, reject) { (function next() {
    ...
    gamePrototype.changeMetaViewport = function() {
        ...
        if ($metaviewport && metaViewPortSetting) {
            if ( !! ua.match(/iPhone|iPod|Tizen/i)) metaViewPortSetting = 'width=device-width, user-scalable=0, minimum-scale=1.0, initial-scale=0.5, maximum-scale=0.5, minimal-ui';
            else if ( !! ua.match(/iPad/i)) metaViewPortSetting = 'width=device-width, user-scalable=0, minimum-scale=1.0, initial-scale=1.0, maximum-scale=1.0, minimal-ui';
            else if ( !! ua.match(/Android/i)) metaViewPortSetting = 'width=device-width, initial-scale=1, maximum-scale=1.01';
...
fg_api.prototype.flashModule = function() {
    ...
    flashPrototype.init = function() {
        ...
        //self.log("Go!");
        window.famobi_gameJS = window.famobi_gameJS || [];
        window.famobi_gameJS.unshift("/flashgames/swfobject/swfobject.js",
        function() {
...
fg_api.prototype.payModule = function() {
    ...
    module.prototype.init = function() {
        ...
        self.iframe.subscribePostMessageListener("pay", "selectMethod",
        function(data) {
            M.selectMethod(data.method);
        }).subscribePostMessageListener("pay", "selectMethod2",
        function(data) {
            // M.selectMethod(data.method);
        }).subscribePostMessageListener("pay", "trackError",
        function(data) {
            M.trackError(data.errorMsg);
        }).subscribePostMessageListener("pay", "trackCountry",
        function(data) {
    ...
    module.prototype.buy = function(itemId, paymentSystem) {
        ...
        websocketApi.getPromise().then(widgetUrlPromise).then(function(url) {
            return url;
            // self.game.hideCanvas();
    ...
    module.prototype.getPaymentWidgetUrl = function(itemId, paymentSystem) {
        ...
        return new Promise(function(resolve, reject) {
            Promise.resolve(websocketApi.getPromise()).then(function() {
                self.rest.getJSON(M.paymentApiUrl + "/widget/mtx?" + "widget=" + widget + "&amount=" + item.price + "&currencyCode=" + (item.currency || "EUR") + "&ag_name=" + encodeURIComponent(item.name + ' ' + document.title) + "&ag_external_id=" + itemId + "&ag_type=fixed" + "&portalid=" + self.config.pid + "&gameid=" + self.config.uuid + "&uid=" + self.player.getId()).then(resolve, reject);
            });
        });
    };
    ...
    module.prototype.getPaymentWidgetUrls = function(itemId, paymentSystems) {
        ...
        for (y in paymentSystems) {
            ...
            widgetUrls[key] = M.paymentUrl + '?' + "usertxid=" + self.localStorage.getItem('pay.txid') + "&userid=" + self.player.getId() + '&gameid=' + self.config.uuid + '&portalid=' + self.config.pid + '&item=' + itemId + '&name=' + encodeURIComponent(item.name + ', ' + document.title) + '&price=' + item.price + '&ps=' + key;
        }
...
fg_api.prototype.videoadsModule = function() {
    ...
    module.prototype.getAdTagUrl = function() {
        ...
        // @see https://support.google.com/dfp_premium/answer/1068325?hl=de
        myadTagUrl = "https://securepubads.g.doubleclick.net/gampad/ads?impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";
...
fg_api.prototype.init = function() {
    ...
    if (self.config.gameParams.overlay_position) self.fgOverlay.className = 'overlay-' + self.config.gameParams.overlay_position + ' clip-' + self.config.gameParams.overlay_position;

    if (self.config.gameParams.overlay_distance && self.config.gameParams.overlay_distance !== '') {
        if (self.config.gameParams.overlay_position && self.config.gameParams.overlay_position == "bottom") self.fgOverlay.style.bottom = self.config.gameParams.overlay_distance + "px";
        else self.fgOverlay.style.top = self.config.gameParams.overlay_distance + "px";
    }
    ...
    Promise.all([self.game.prepare(), loadStylesheet(), loadMoreGamesButton()]).then(onloadCallback).
