        ...
        var t = function () {
            ...
            return a.prototype.introTween = function () {
                ...
                a.prototype.render = function () {
                    if (ctx.drawImage(this.oHorizonImgData.img, 0, 0, this.oHorizonImgData.img.width, this.oHorizonImgData.img.height, canvas.width / 2 - this.oHorizonImgData.img.width / 2 * this.zoomScale, this.horizonY - this.oHorizonImgData.img.height * this.zoomScale, this.oHorizonImgData.img.width * this.zoomScale, this.oHorizonImgData.img.height * this.zoomScale), this.isScrollingGround) for (var a = 0; a < this.scrollSegs; a++) ctx.drawImage(this.oGroundImgData.img, 0, this.oGroundImgData.img.height / this.scrollSegs * a, this.oGroundImgData.img.width, this.oGroundImgData.img.height / this.scrollSegs + 1, canvas.width / 2 - (this.oGroundImgData.img.width / 2 + this.initialTweenX * (a / this.scrollSegs)) * this.zoomScale, this.horizonY + this.oGroundImgData.img.height / this.scrollSegs * a, this.oGroundImgData.img.width * this.zoomScale, this.oGroundImgData.img.height / this.scrollSegs * this.zoomScale + 1);
